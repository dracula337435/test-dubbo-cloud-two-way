 ...
 * 修改了其中的private函数{@link com.tencent.tsf.registry.consul.ConsulRegistry#toServiceName(org.apache.dubbo.common.URL)}和{@link com.tencent.tsf.registry.consul.ConsulRegistry#convert(java.util.List)}
 *
 * @author dk
 */
public class ToCloudTsfConsulRegistryBase extends FailbackRegistry {
    ...
    public ToCloudTsfConsulRegistryBase(URL url) {
        super(url);
